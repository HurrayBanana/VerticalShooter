...
*************************************************/
        ...
        public void StartPreLoader()
        {
            ...
            //fruit
            GM.loadM.AddSoundEffect("fruit", "fruit");
            //on up
            GM.loadM.AddSoundEffect("extra man", "extra man");
            //add the fire sound effect calling it shoot
            GM.loadM.AddSoundEffect("fire", "fire");
            //add the explode sound effect calling it blow up
            GM.loadM.AddSoundEffect("explode", "explode");
